/**
 * The logger module provides interfaces and access needed to use logging in a Cora based system.
 * The logger implementation in use can be accessed through the {@link LoggerProvider} class and its
